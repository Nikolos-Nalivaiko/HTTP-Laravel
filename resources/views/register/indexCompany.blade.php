...
<section class="sign-up sign-up__container page">
    ...
    <x-form.form action="{{ route('register.store.company') }}" method="post">
        ...
        <x-form.footer :button-text="__('Зареєструватись')" :description="__('Реєструючи профіль, ви погоджуєтесь з правилами нашої платформи. Ми цінуємо вашу співпрацю у дотриманні стандартів якості нашої спільноти')"/>
    </x-form.form>
